...
def inference(args, model, save_path=None):
    from datasets.dataset_cvc import CVC_dataset, RandomGenerator_CVC
    db     = CVC_dataset(args.img_dir, args.mask_dir, args.list_dir, split="test",
                         transform=RandomGenerator_CVC([args.img_size]*2))
...
if __name__=='__main__':
    ...
    log_dir='./test_log/test_log_boundary_aware_cvc'; os.makedirs(log_dir,exist_ok=True)
