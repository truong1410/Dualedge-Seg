...
if __name__=='__main__':
    ...
    parser.add_argument('--output_dir',   default='./predictions_dualedge_unet')
    ...
    print(f"Loading DualEdge_UNet [{args.fusion_type}] from {args.model_weight}")
    model=DualEdge_UNet(config,n_classes=args.num_classes,
    ...
    log_dir='./test_log/test_log_dualedge_unet'; os.makedirs(log_dir,exist_ok=True)
